...
import 'package:projectnotes_15/screen_page/page_detail.dart';
import 'package:projectnotes_15/screen_page/page_edit.dart';
import 'package:projectnotes_15/screen_page/page_insert.dart';
...
class _PageUtamaState extends State<PageUtama> {
  ...
  Future<void> getNotes() async {
    try {
      var response = await http.get(Uri.parse('http://192.168.1.7/notesDB/getNotes.php'));
  ...
  Future<void> deleteNote(String id) async {
    try {
      var response = await http.post(
        Uri.parse('http://192.168.1.7/notesDB/deleteNote.php'),
        body: {'id': id},
      );
      var jsonData = json.decode(response.body);
